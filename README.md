# Melissa - Global Address Object Java Wrappers

## Purpose

This is the code for you to run Global Address Object in Java.
...
## Getting Started
These instructions will get you a copy of the wrappers needed to run the Java Global Address Object on your local machine. 
...
Import the `com` folder, and `mdGlobalAddrJavaWrapper.dll` (Windows) or `libmdGlobalAddrJavaWrapper.so` (Linux) to your project, and include the following line in your code to begin using the wrapper.
...
#### Configure Scripts
If you want to generate `mdGlobalAddrJavaWrapper.dll`, you will execute the `BuildGlobalAddrJavaWrapper.ps1` script. This may require you to configure some path variables in `Build.ps1` and `BuildGlobalAddrJavaWrapper.ps1`.
...
It is important to note that you must be able to initialize the Visual Studio Developer Command Prompt environment for `x86_x64` to generate `mdGlobalAddrJavaWrapper.dll`.
...
#### Configure Script
If you want to generate `libmdGlobalAddrJavaWrapper.so`, you will execute the `BuildGlobalAddrJavaWrapper.sh` script. This may require you to configure some path variables in `BuildGlobalAddrJavaWrapper.sh`.
...
----------------------------------------
## See also
- [Melissa - Global Address Object Windows Java](https://github.com/MelissaData/GlobalAddressObject-Java)
- [Melissa - Global Address Object Linux Java](https://github.com/MelissaData/GlobalAddressObject-Java-Linux)
